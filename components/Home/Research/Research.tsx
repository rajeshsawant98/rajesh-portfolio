      ...
      <div className="w-[80%] mx-auto mt-20 max-w-4xl space-y-8">
        {researchData.map((paper, i) => (
          <AnimateIn key={paper.id} animation="fade" direction="up" delay={i * 0.1}>
            <div className="bg-card-dark rounded-xl p-6 md:p-8 border border-gray-200 dark:border-gray-800">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    {paper.topics.map((topic) => (
                      <span
                        key={topic}
                        className="text-xs px-3 py-1 rounded-full bg-purple-100 dark:bg-gray-800 text-gray-700 dark:text-gray-400 border border-purple-200 dark:border-gray-700"
                      >
                        {topic}
                      </span>
                    ))}
